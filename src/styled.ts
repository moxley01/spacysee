...
export const FixedParagraph = styled.section<{ hidden: boolean }>`
  ...
  position: ${(props: { hidden: any }) => (props.hidden ? "static" : "sticky")};
...
export const TokenDetails = styled.div`
  ...
  border-top: 2px solid
    ${(props: { theme: { colors: { gray: any } } }) => props.theme.colors.gray};
  & > h2 {
...
//   }) => (props.outlined ? "initial" : props.theme.colors.primary)}!important;
//   color: ${(props: { outlined: any; theme: { colors: { primary: any } } }) =>
//     props.outlined ? props.theme.colors.primary : "white"}!important;
//   &[data-large="true"] {
//     // margin: 20px;
...
//   &[data-large="false"] {
//     transform: scale(
//       ${(props: { outlined: any }) => (props.outlined ? 1 : 0.6)}
//     );
//   }
// `;

// export const NextPageButtonLeft = styled`
//   position: fixed;
//   left: 0px;
//   top: 50%;
...
// export const NextPageButtonRight = styled`
//   position: fixed;
//   right: 0px;
//   top: 50%;
...
// export const OverlayPanel = styled`
//   & button {
//     background: ${(props: { theme: { colors: { primary: any } } }) =>
//       props.theme.colors.primary}!important;
//   }
// `;
...
// export const LanguageButton = styled<{ isSelected: boolean }>`
//   margin: 0.5em;
//   width: 100px;
//   height: 60px;
...
//       props.isSelected ? "black" : "transparent"} !important;
// `;
